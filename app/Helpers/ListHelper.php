...
class ListHelper
{
    ...
    /**
     * Get market list for form dropdown.
     *
     * @param  int $state_id
     *
     * @return array
     */
    public static function marts($state_id = null)
    {
        return \DB::table('markets')->where('state_id', $state_id)->orderBy('name', 'asc')->pluck('name', 'id', 'slug', 'working_hours');
    }
    
    public static function stores($market_id = null)
    {
        return \DB::table('stores')->where('market_id', $market_id)->orderBy('name', 'asc')->pluck('name', 'id', 'slug');
    }
