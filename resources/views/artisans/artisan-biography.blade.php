            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="sidebar col-md-5">
                        ...
                        @php
                            $projects = \App\ArtisanProject::where('user_id', $artisan->user_id)->where('approve',1)->latest()->take(3)->get();
                        @endphp

                        @if(count($projects)>0)
                            <div class="widget clearfix" style="margin-top:17px">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-bio ">
                                        <h6>About Jobs From {{$artisan->user->name}}</h6>
                                    </div>
                                    <div class="panel-body">
