...
@endphp
    ...
    <div class="col-lg-9">
        ...
        <form action="{{route('update-job-post')}}" name='editForm' enctype='multipart/form-data' method="POST">
            {{ csrf_field() }}
              ...
              <div class="form-group">
                ...
                <input type="text" name="title" value="{{$project->title}}" id="title" class="{{ $errors->has('title') ? 'form-control is-invalid' : 'form-control' }}" placeholder="Project Title" required>
                @if ($errors->has('title'))
              ...
              <div class="form-group">
                ...
                <input type="text" name="keywords" value="{{$project->keywords}}" id="keywords" class="{{ $errors->has('keywords') ? 'form-control is-invalid' : 'form-control' }}" placeholder="Project Keywords ..." required>
              ...
              <div class="form-group">
                ...
                <textarea name="description" id="area1" class="{{ $errors->has('description') ? 'form-control is-invalid' : 'form-control' }}" required> {{$project->description}} </textarea>
              ...
              <div class="form-group">
                ...
                <input type="text" name="experience" value="{{$project->experience}}" id="experience" class="{{ $errors->has('experience') ? 'form-control is-invalid' : 'form-control' }}" placeholder="Experience" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="input-group input-group-md date" id="date"
                                ...
                                <input type="text" name="deadline" class="form-control" value="{{date('m/d/Y', strtotime($project->deadline))}}" required>
                    ...
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-new thumbnail"
                            ...
                            @else
                                ...
                                <img style="width: 200px"
                                     src="{{asset('assets/artisan/images/project/'.$project->image)}}"
                                     alt="...">
                            @endif
                ...
                <div class="col-md-12">
                    <br>
                    <input type="submit" class="btn btn-block artisan-btn mb-4" value="Edit Job">
                </div>
            </div>
        </form>
        </div>
