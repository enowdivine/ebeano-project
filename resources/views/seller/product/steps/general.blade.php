    ...
    <div class="col-lg-9">
        ...
        <div class="card shadow-sm my-3 px-3 rounded justify-content-center border-0">
            ...
            <div class="card-title px-3 py-2 mb-0 mt-3">
                <h4 class="text-center">Product Information ( {{ $category->name }} )</h4>
            </div>
            <div class="card-body">
                <form action="{{route('seller.product_action',['step'=>'general', 'action' => 'save'])}}" method="POST" enctype="multipart/form-data" id="product_form">
                ...
                <div class="row mb-2">
                    ...
                    <div class="form-group col-md-6">
                        <label class="control-label font-weight-bold" for="name">Product Name</label>
                    ...
                    <div class="form-group col-md-12">
                        <label class="control-label font-weight-bold mb-3 text-left" for="weight">Product Description:</label>
                        <textarea name="full_description" class="summernote form-control" rows="10"></textarea>
                    </div>
                    
                    <div class="form-group col-md-6">
                        <div class="checkbox checkbox-success checkbox-circle">
                            <input id="checkbox-10" type="checkbox" name="publish" value="1">
