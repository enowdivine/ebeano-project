    ...
    <div class="col-lg-9">
        ...
        <div class="card shadow-sm my-3 px-3 rounded justify-content-center border-0">
            ...
            <div class="card-body">
                ...
                <div class="row mb-2">
                    <div class="col-sm-3">
                        <div class="nav flex-column nav-pills  mb-4" id="v-pills-tab" style="background-color: #f2f2f2;border-radius: 4px" role="tablist"
                            aria-orientation="vertical">
                                ...
                                <a class="nav-link" id="choice-tab" data-toggle="pill" href="#cust_choice" role="tab"
                                    aria-controls="cust_choice" aria-selected="false">Customer Choice</a>
                            
                            
                                <a class="nav-link" id="price-tab" data-toggle="pill" href="#price" role="tab"
                                    aria-controls="price" aria-selected="false">Price and Quantity</a>
                                ...
                                <a class="nav-link" id="desc-tab" data-toggle="pill" href="#desc" role="tab"
                                    aria-controls="desc" aria-selected="false">Description</a>
                            
                            
                                <a class="nav-link" id="shipping-tab" data-toggle="pill" href="#shipping" role="tab"
                                    aria-controls="shipping" aria-selected="false">Shipping Info</a>
                            
                            
                                <a class="nav-link" id="spec-tab" data-toggle="pill" href="#spec" role="tab"
                    ...
                    <div class="col-sm-9">
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="general" role="tabpanel"
                                ...
                                <button class="btn btn-default my-20" data-toggle="pill" href="#images" role="tab" aria-controls="images" aria-selected="true">Next</button>
                            </div>
                            {{-- images --}}
                            <div class="tab-pane fade" id="images" role="tabpanel" aria-labelledby="images-tab">
                               ...
                               <button class="btn btn-default my-20 " data-toggle="pill" href="#cust_choice" aria-selected="false">Next</button>
                            </div>
                            {{-- Customer choice --}}
                            <div class="tab-pane fade" id="cust_choice" role="tabpanel" aria-labelledby="choice-tab">
                                        @php
                                ...
                                <div class="form-group  mt-20">
                                    ...
                                    <!--<select id="colors" class="form-control"  multiple="multiple" style="display: none;" name="colors[]" >   -->
                                       
                                    <!--    @foreach ($colors as $color)-->
                                        
                                    <!--<option value="{{$color->code}}" {{(!empty($edit->colors) && in_array($color->code,$color_array ?? ''))?'selected':''}}>{{$color->name}}</option>  -->
                                    <!--    @endforeach-->
                                    <!--</select>-->
                                </div>
                                <div class="form-group">
                                ...
                                @endforeach
                                <button class="btn btn-default my-20" data-toggle="pill" href="#price" aria-controls="price" aria-selected="false">Next</button>
                            </div>
                            {{-- Price and Qty --}}
                            <div class="tab-pane fade" id="price" role="tabpanel" aria-labelledby="price-tab">
                                ...
                                <button class="btn btn-default my-20 " data-toggle="pill" href="#seo" aria-controls="seo" aria-selected="false">Next</button>
                            </div>
                            {{-- SEO --}}
                            <div class="tab-pane fade" id="seo" role="tabpanel" aria-labelledby="seo-tab">
                                ...
                                <button class="btn btn-default my-20 " data-toggle="pill" href="#desc" aria-controls="desc" aria-selected="false">Next</button>
                            </div>
                            {{-- Desc --}}
                            <div class="tab-pane fade" id="desc" role="tabpanel" aria-labelledby="desc-tab">
                                ...
                                <textarea name="full_description" class="summernote form-control" rows="25">{{!empty($edit->description)?$edit->description:($edit->full_description ?? '')}}</textarea>
                                </div>
                            <button class="btn btn-default my-20 " data-toggle="pill" href="#shipping" aria-controls="shipping" aria-selected="false">Next</button>
                            </div>
                            {{-- Shipping --}}
                            <div class="tab-pane fade" id="shipping" role="tabpanel" aria-labelledby="shipping-tab">
                                ...
                                <button class="btn btn-default my-20 " data-toggle="pill" href="#spec" aria-controls="spec" aria-selected="false">Next</button>
                            </div>
                            ...
                            <div class="tab-pane fade" id="spec" role="tabpanel" aria-labelledby="spec-tab">
                                ...
                                <textarea name="specifications" class="summernote form-control mb-3" rows="25">{{!empty($edit->specification)?$edit->specification:($edit->specifications ?? '')}}</textarea>
                            <div class="pull-right my-20">
                            
                            <button class="btn btn-default my-20 " data-toggle="pill" href="#general" role="tab" aria-controls="shipping" aria-selected="false">First</button> <input type="submit" class="btn btn-primary btn-anim" name="save" value="Save">
                            </div>
                            </div>
