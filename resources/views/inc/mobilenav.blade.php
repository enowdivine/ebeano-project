 ...
 <!--                                    <g id="_481121840">-->
 <!--                                        <path class="fil0"-->
 <!--                                            d="M43 173c5,8 15,16 38,25 145,0 281,0 422,1 -25,9 -45,17 -61,26 -72,-5 -144,-11 -216,-17 -135,-6 -179,4 -224,14 8,-19 21,-35 41,-49z" />-->
 <!--                                        <path class="fil0"-->
 <!--                                            d="M60 7c24,14 38,35 36,63 11,-3 23,-7 38,-9 0,-8 0,-12 0,-20 -24,-10 -49,-24 -74,-34z" />-->
 <!--                                        <ellipse class="fil0" cx="121" cy="243" rx="33" ry="24" />-->
 <!--                                        <ellipse class="fil0" cx="384" cy="249" rx="33" ry="24" />-->
 <!--                                        <path class="fil1"-->
 <!--                                            d="M900 67c31,3 70,15 102,3 -12,13 -24,27 -36,40 -12,-29 -38,-37 -66,-43z" />-->
 <!--                                        <g transform="matrix(0.934393 0 -0.167358 0.761815 -396.527 78.412)">-->
 <!--                                            <text x="500" y="133" class="fil1 fnt0">e</text>-->
 <!--                                            <text x="662" y="133" class="fil1 fnt0">b</text>-->
 <!--                                            <text x="827" y="133" class="fil1 fnt0">e</text>-->
 <!--                                        </g>-->
 <!--                                        <g transform="matrix(0.945143 0 -0.156298 0.761801 37.7326 82.987)">-->
 <!--                                            <text x="500" y="133" class="fil0 fnt1">ano</text>-->
 <!--                                        </g>-->
 <!--                                        <g transform="matrix(1.03864 0 0 0.761815 0.690618 127.122)">-->
 <!--                                            <text x="500" y="133" class="fil2 str1 fnt2">M</text>-->
 <!--                                            <text x="548" y="133" class="fil2 str1 fnt2">A</text>-->
 <!--                                            <text x="588" y="133" class="fil2 str1 fnt2">R</text>-->
 <!--                                            <text x="628" y="133" class="fil2 str1 fnt2">K</text>-->
 <!--                                            <text x="670" y="133" class="fil2 str1 fnt2">E</text>-->
 <!--                                            <text x="707" y="133" class="fil2 str1 fnt2">T</text>-->
 <!--                                            <text x="737" y="133" class="fil2 str1 fnt2">.</text>-->
 <!--                                            <text x="756" y="133" class="fil2 str1 fnt2">C</text>-->
 <!--                                            <text x="796" y="133" class="fil2 str1 fnt2">O</text>-->
 <!--                                            <text x="838" y="133" class="fil2 str1 fnt2">M</text>-->
 <!--                                        </g>-->
 <!--                                    </g>-->
 <!--                                </g>-->
 <!--                            </svg>-->
         ...
         <div class="row">
             ...
             <div class="col-8 text-right d-none d-lg-block">
                 <ul class="inline-links nav">
                     <li>
                         <a href="/vendors/registration" class="top-bar-item">Sell on Ebeano</a>
                     </li>
                     <li>
                         <a href="/contact" class="top-bar-item">Contact us</a>
                     </li>
                     <li>
                     ...
                     <li class="nav-item dropdown">
                         ...
                         <ul class="dropdown-menu border-0">
                             <li><a class="dropdown-item" href="user/account"><span class="la la-user-alt mr-2"></span>
                                     account</a></li>
             ...
             <div class="side-menu-list px-3">
                 ...
                 <!-- <div class="sidebar-widget-title py-0">
                   ...
                   <ul class="side-seller-menu">
                                                   <li>
                           <a href="https://ac.nosprodev.com/search?category=Demo-category-1" class="text-truncate">
                               <img class="cat-image lazyload" src="https://ac.nosprodev.com/public/frontend/images/placeholder.jpg" data-src="https://ac.nosprodev.com/public/uploads/categories/icon/KjJP9wuEZNL184XVUk3S7EiZ8NnBN99kiU4wdvp3.png" width="13" alt="Demo category 1">
                               <span>Demo category 1</span>
                           </a>
                       </li>
                                                   <li>
                           <a href="https://ac.nosprodev.com/search?category=Demo-category-2" class="text-truncate">
                               <img class="cat-image lazyload" src="https://ac.nosprodev.com/public/frontend/images/placeholder.jpg" data-src="https://ac.nosprodev.com/public/uploads/categories/icon/h9XhWwI401u6sRoLITEk9SUMRAlWN8moGrpPfS6I.png" width="13" alt="Demo category 2">
                               <span>Demo category 2</span>
                           </a>
                       </li>
                                                   <li>
                           <a href="https://ac.nosprodev.com/search?category=Demo-category-3" class="text-truncate">
                               <img class="cat-image lazyload" src="https://ac.nosprodev.com/public/frontend/images/placeholder.jpg" data-src="https://ac.nosprodev.com/public/uploads/categories/icon/rKAPw5rNlS84JtD9ZQqn366jwE11qyJqbzAe5yaA.png" width="13" alt="Demo category 3">
                               <span>Demo category 3</span>
                           </a>
                       </li>
                                           </ul> -->
             </div>
