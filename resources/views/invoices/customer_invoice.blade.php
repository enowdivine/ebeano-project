	...
	<div>
		...
		<div style="background: #eceff4;padding: 1.5rem;">
			<table>
				<tr>
					<td>
						@if(isset($generalsetting) && $generalsetting->logo != null)
							<img loading="lazy"  src="{{ asset($generalsetting->logo) }}" height="40" style="display:inline-block;">
						@else
							<img loading="lazy"  src="{{asset('assets/images/ebeano-logo.png')}}" height="40" style="display:inline-block;">
						@endif
					</td>
			...
			<table>
				<tr>
					<td style="font-size: 1.2rem;" class="strong">{{ 'Ebeano Market' }}</td>
					<td class="text-right"></td>
				</tr>
				<tr>
					<td class="gry-color small">{{ '38 Umuezebi St., New Haven, Enugu' }}</td>
					<td class="text-right"></td>
				</tr>
				<tr>
					<td class="gry-color small">Email: {{ 'billing@ebeanomarket.com' }}</td>
					<td class="text-right small"><span class="gry-color small">Order ID:</span> <span class="strong">{{ $order->code }}</span></td>
				</tr>
				<tr>
					<td class="gry-color small">Phone: {{ '' }}</td>
