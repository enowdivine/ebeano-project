...
<div class="profile-nav my-4 px-3">
    <ul class="nav card shadow-sm rounded-lg border-0 h-100 d-block justify-content-center" style="background-image: -webkit-linear-gradient(0deg, rgb(128 13 144) 0%, #c80faa 100%);">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{route('estate.dashboard')}}"><i class="la la-dashboard mr-3"> </i> Dashboard</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{route('estate.create.property')}}"><i class="la la-plus-circle mr-3"> </i> Post Property</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{route('estate.all.property')}}"><i class="la la-home mr-3"> </i> My Properties</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{route('estate.customer.request')}}"><i class="la la-comment-alt mr-3"> </i> Manage Requests</a>
        </li>
        <li class="nav-item">
