        ...
        <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2">
            <div class="card px-0 pb-0 mt-3 mb-3 bg-white">
                <div class="row">
                 ...
                 <div class="card-body">
                     @php
                     $data = \App\Marketer::where('ref_code',$ref_code)->first();
                     if ($data == null){
                     $data = \App\User::where('ref_code',$ref_code)->first();
                     }
                     @endphp
                     <h4 id="heading">Dear {{$data->name}}, Your Unique Referal Code is <span style="color:green">{{$ref_code ?? ''}}</span></h4>
                    <p class="text-info"><i class="fa fa-info"></i> Please copy the above code and keep it safe.</p>
