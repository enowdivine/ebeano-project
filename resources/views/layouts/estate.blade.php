...
@if(!isset($detailedProduct) && isset($generalsetting))
    ...
    <!-- Twitter Card data assets/estate/images/banner.png -->
    ...
    <meta property="og:type" content="Ebeano Real Estate" />
...
@endif
    ...
    <title>@yield('title', config('app.name', 'Ebeano Real Estate'))</title>

    <!-- Fonts @import url("https://fonts.googleapis.com/css?family=Livvic:300,400,600,700&display=swap");@import url("https://fonts.googleapis.com/css2?family=Livvic:wght@400;500;600;700&display=swap"); -->
    ...
    <style>
        ...
        .action-link a{
            border-radius: 22px;
            margin-right: 5px;
            box-shadow: 0 3px 5px 0 rgb(255 94 34 / 57%);
            background:#eb790f; font-size:14px; color:#FFF; padding:9px 10px; display:inline-block; }
        .action-link a:hover{background:transparent; border: 1px solid #eb790f; color:#eb790f;; text-decoration:none;  }
        
        .carousel-item a{
            border-radius: 22px;
                box-shadow: 0 3px 5px 0 rgb(255 94 34 / 57%);
            background:#eb790f; font-size:14px; color:#FFF; padding:13px 32px; display:inline-block; }
        .carousel-item a:hover{background:transparent; border: 1px solid #eb790f; text-decoration:none;  }
        ...
        .features-absolute.blog-search{margin:-120px 0 0px}
        @media (max-width: 768px){
            .features-absolute.blog-search{margin:-90px 0 0px}}
            .categories{transition:all 0.5s ease}
            .categories:hover{transform:translateY(-10px);box-shadow:0 0 3px rgba(60,72,88,0.15)}.categories a:hover{color:#2f55d4 !important}
...
<body>
    ...
    <div class="header">
        @include('inc/estate_nav')
    </div>
    
    @if(isset($page_name) && $page_name =='homepage')
         ...
         <div class="mask flex-center">
            <div class="container">
               <div class="row align-items-center">
                  <div class="col-md-7 col-12 order-md-1 order-2" style="background: rgba(0,0,0,.5);padding-bottom:10px">
                     <div class="carousel_caption">
                        <h1>Affordable Housing</h1>
                        <h2>Find Your Next Home Easily</h2>
                        <p>Browse through our real estate resource to see properties meant for sale</p>
                        <a href="#">Browse</a>
                     </div>
                  </div>
                  <div class="col-md-5 col-12 order-md-2 order-1"><img src="{{ asset('assets/estate/images/house-for-sale-ebeano.png') }}" style="height:400px;" class="mx-auto" alt="House for Sale on Ebeano"></div>
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="mask flex-center">
            <div class="container">
               <div class="row align-items-center">
                  <div class="col-md-7 col-12 order-md-1 order-2" style="background: rgba(0,0,0,.5);padding-bottom:10px">
                     <div class="carousel_caption">
                        <h1>Affordable Land</h1>
                        <h2>Be the Next to Own a Land</h2>
                        <p>You can own a landed property of yours today when you go through our listings</p>
                        <a href="#">More View</a>
                     </div>
                  </div>
                  <div class="col-md-5 col-12 order-md-2 order-1"><img src="{{ asset('assets/estate/images/city.png') }}" class="mx-auto" style="height:400px;" alt="Be the Next to Own a Land on Ebeano"></div>
               </div>
            </div>
         </div>
      </div>
               ...
               <div class="row align-items-center">
                  <div class="col-md-7 col-12 order-md-1 order-2" style="background: rgba(0,0,0,.5);padding-bottom:10px">
                     <div class="carousel_caption">
                        ...
                        <h2>Verified Properties Listed are Secure</h2>
                        <p>Properties verified and listed are surely secure and safe for purchase</p>
                        <a href="#">View Now</a>
                     </div>
                  </div>
                  <div class="col-md-5 col-12 order-md-2 order-1"><img src="{{ asset('assets/estate/images/secure-property.png') }}" class="mx-auto" style="height:400px;" alt="Verified Properties Listed are Secure on Ebeano"></div>
               </div>
            </div>
         </div>
      </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="#">Hotel & Airline booking</a></li>
...
<div class="mt-5 mb-5">
    ...
    <script src="{{ asset('assets/js/filter.min.js') }}"></script>
    <script src="{{ asset('assets/js/tobii.min.js?v1') }}"></script>
