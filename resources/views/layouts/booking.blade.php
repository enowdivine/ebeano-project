...
@if(!isset($detailedProduct) && isset($generalsetting))
    ...
    <meta property="og:type" content="Ebeano Artisans" />
...
@endif
    ...
    <!-- Favicon -->
    {{--
    <link type="image/x-icon" href="{{ asset($generalsetting->favicon) }}" rel="shortcut icon" />
    --}}

    <title>@yield('title', config('app.name', 'Ebeano Bookings'))</title>
    ...
    @if(isset($page_title) && $page_title=='Welcome to Ebeano Bookings')
        <link rel="stylesheet" href="{{asset('assets/booking/assets/plugin/toastr/build/toastr.min.css')}}">
    <link href="{{asset('assets/booking/assets/frontend/')}}/css/themify-icons.css" rel="stylesheet">
    <link href="{{asset('assets/booking/assets/frontend/')}}/css/magnific-popup.css" rel="stylesheet">
    <link href="{{asset('assets/booking/assets/frontend/')}}/css/jquery-ui.css" rel="stylesheet">
    <link href="{{asset('assets/booking/assets/frontend/')}}/css/slick.css" rel="stylesheet">
    <link href="{{asset('assets/booking/assets/frontend/')}}/css/animate.css" rel="stylesheet">
    <link href="{{asset('assets/booking/assets/frontend/')}}/css/owl.carousel.min.css" rel="stylesheet">


    <!-- Main css -->
    <link href="{{asset('assets/booking/assets/frontend/')}}/css/main.css" rel="stylesheet">
    <link href="{{asset('assets/booking/assets/frontend/')}}/css/color.php?color=830D92&color_2=eb790f" rel="stylesheet">
    @else
    <!--<link rel="stylesheet" href="{{asset('assets/booking/assets/backend/css/bootadmin.css')}}">-->
    <link rel="stylesheet" href="{{asset('assets/booking/assets/backend/css/custom.css')}}">
    <link rel="stylesheet" href="{{asset('assets/booking/assets/plugin/toastr/build/toastr.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/booking/assets/plugin/bootstrap-toggle/css/bootstrap2-toggle.min.css')}}">

    <link rel="stylesheet" href="{{asset('assets/booking/assets/plugin/select2/dist/css/select2.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/booking/assets/plugin/select2-bootstrap-theme/dist/select2-bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/booking/assets/plugin/gijgo-combined-1.9.11/css/gijgo.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/booking/assets/plugin/date-time/mdtimepicker.min.css')}}">
    <link href="{{url('/')}}/assets/booking/assets/backend/css/color.php?color=830D92" rel="stylesheet">
    @endif
    ...
    <script src="https://stormmarts.com/artisan/assets/admin/js/sweetalert.js"></script>
    <link rel="stylesheet" href="https://stormmarts.com/artisan/assets/admin/css/sweetalert.css">
...
<body>
    ...
    <div class="header">
        @include('inc/booking_welcome_nav')
    </div>

    <div class="container mobile-container" id="app">
    ...
    <!--modal for booking -->
    <div style="margin-top:100px" class="modal fade" id="book_now" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                
                <div class="row" style="padding-bottom:30px;padding-left:10px;padding-right:10px">
                    <div class="col-md-4 offset-md-2">
                        <div class="dashboard-widget text-center eb-widget text-white mt-4 c-pointer" onclick="javascript:location.href='/room-list';">
                            <i class="fa fa-home"></i>
                            <span class="d-block title heading-3 strong-400">Book Hotels</span>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="dashboard-widget text-center eb-widget-2 text-white mt-4 c-pointer" onclick="javascript:location.href='/flight-list';">
                            <i class="fa fa-plane"></i>
                            <span class="d-block title heading-3 strong-400">Book Flights</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="#">Sell on Ebeano</a></li>
                            
                        </ul>
                    </div>
                </div>
                <div class="footer-copyright text-center justify-content-center mt-3 py-4">
                    <span class="la la-copyright text-white"></span> 2020 <a href="/">Ebeano Market</a>
                </div>
            </div>
        </div>
    </div>
<div class="mt-5 mb-5">
    ...
    <div class="modal fade" id="viewJobDetails">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document">
            <div class="modal-content position-relative">
                ...
                <div id="viewJobDetails-modal-body">
    ...
    <!-- Javascript -->
    @if((isset($page_title) && $page_title !=='Welcome to Ebeano Bookings') || !isset($page_title))
    <script src="{{asset('assets/booking/assets/backend/js/bootadmin.min.js')}}"></script>
    <script src="{{asset('assets/booking/assets/plugin/niceditor/nicEdit.js')}}"></script>
    <script src="{{asset('assets/booking/assets/plugin/select2/dist/js/select2.min.js')}}"></script>
    <script src="{{asset('assets/booking/assets/plugin/gijgo-combined-1.9.11/js/gijgo.min.js')}}"></script>
    <script src="{{asset('assets/booking/assets/plugin/moment/moment.min.js')}}"></script>
    <script src="{{asset('assets/booking/assets/plugin/date-time/mdtimepicker.min.js')}}"></script>
    <script src="{{asset('assets/booking/assets/plugin/print_this.js')}}"></script>
    <script src="{{asset('assets/booking/assets/plugin/vue/vue.js')}}"></script>
    <script src="{{asset('assets/booking/assets/plugin/axios/axios.js')}}"></script>
    <script src="{{asset('assets/booking/assets/backend/js/custom.js')}}"></script>
    ...
    <script src="{{asset('assets/booking/assets/plugin/toastr/build/toastr.min.js')}}"></script>
    <script>
        toastr.options = {
            "closeButton": false,
            "debug": false,
    ...
    <script src="{{asset('assets/booking/assets/frontend/')}}/js/jquery-3.2.1.min.js"></script>
    <script src="{{asset('assets/booking/assets/frontend/')}}/js/jquery-migrate.js"></script>
    <script src="{{asset('assets/booking/assets/plugin/moment/moment.min.js')}}"></script>
    <script src="{{asset('assets/booking/assets/frontend/')}}/js/jquery-ui.js"></script>
    <!-- Include all compiled plugins (below), or include individual files as needed -->
    <script src="{{asset('assets/booking/assets/frontend/')}}/js/owl.carousel.min.js"></script>
    
    <script src="{{asset('assets/booking/assets/frontend/')}}/js/waypoints.min.js"></script>
    <script src="{{asset('assets/booking/assets/frontend/')}}/js/jquery.counterup.min.js"></script>
    
    <script src="{{asset('assets/booking/assets/frontend/')}}/js/magnific-popup.min.js"></script>
    <script src="{{asset('assets/booking/assets/frontend/')}}/js/imagesloaded.pkgd.min.js"></script>
    <script src="{{asset('assets/booking/assets/frontend/')}}/js/isotope.pkgd.min.js"></script>
    <script src="{{asset('assets/booking/assets/frontend/')}}/js/slick.min.js"></script>
    
    <script src="{{asset('assets/booking/assets/frontend/')}}/js/wow.min.js"></script>
    <script src="{{asset('assets/booking/assets/frontend/')}}/js/script.js"></script>
    <script src="{{asset('assets/booking/assets/plugin/toastr/build/toastr.min.js')}}"></script>
    <script>
        toastr.options = {
            "closeButton": false,
