        ...
        <div class="row">
            <div class="px-2 col-md-9">
                ...
                <div class="card rounded-lg shadow-sm border-0 px-3 mb-4 pt-4">
                    <form action="{{route('registrar.start-complete.eforms', ['reference'=>$order->form_id, 'orderID'=>$order->txn_code, 'hash'=>$hash])}}" name='addForm' enctype='multipart/form-data' method="POST">
                        {{ csrf_field() }}
