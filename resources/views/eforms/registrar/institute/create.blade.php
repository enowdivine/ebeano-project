    ...
    <div class="col-lg-9">
        ...
        <div class="card artisan-card shadow-sm my-4 px-3 rounded justify-content-center border-0">
            <div class="card-title px-3 py-2 mb-0">
                <h3 class="text-center">Create Institute <i class="la la-plus-circle mr-3"> </i> </h3>
            </div>
            <div class="card-body">
                
        <form action="{{route('registrar.create.post.institute')}}" name='addForm' enctype='multipart/form-data' method="POST">
            {{ csrf_field() }}
            
              <div class="form-group">
                <label for="title" class="sr-only"><strong>Institution Name :</strong></label>
                <input type="text" name="name" id="title" class="{{ $errors->has('title') ? 'form-control is-invalid' : 'form-control' }}" placeholder="Institution Name" required>
                @if ($errors->has('title'))
              ...
              <div class="form-group">
                ...
                <input type="text" name="institute_tagline" id="tagline" class="{{ $errors->has('tagline') ? 'form-control is-invalid' : 'form-control' }}" placeholder="Institution Tagline/Motto" required>
              ...
              <div class="form-group">
                ...
                <textarea name="school_description" placeholder="Type here..." id="area1" class="{{ $errors->has('description') ? 'form-control is-invalid' : 'form-control' }}" ></textarea>
              ...
              <div class="form-group">
                ...
                <input type="text" name="address" id="address" class="{{ $errors->has('address') ? 'form-control is-invalid' : 'form-control' }}" placeholder="Institution Address" required>
              ...
              <div class="form-group">
                ...
                <input type="text" name="country" id="country" class="{{ $errors->has('country') ? 'form-control is-invalid' : 'form-control' }}" placeholder="Institution Country" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="web" id="website" class="{{ $errors->has('website') ? 'form-control is-invalid' : 'form-control' }}" placeholder="Institution Website" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="fb" id="facebook" class="{{ $errors->has('facebook') ? 'form-control is-invalid' : 'form-control' }}" placeholder="Institution Facebook" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="twitter" id="twitter" class="{{ $errors->has('twitter') ? 'form-control is-invalid' : 'form-control' }}" placeholder="Institution Twitter" required>
