...
<div class="row">
    ...
    <div class="card shadow-sm my-4 px-3 rounded justify-content-center border-0">
            ...
            <h2>Guest
                <a class="btn btn-tsk float-right" href="{{route('guests')}}"><i class="fa fa-list"></i> Guest List</a>
                                ...
                                <div class="col-md-9 ">
                                    ...
                                    <div class="tile">
                                        <div class="tile-body">
                                            ...
                                            <form action="{{route('guests.update',$guest->id)}}" method="post" enctype="multipart/form-data">@csrf
                                                <div class="form-row justify-content-center">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="email" class="form-control form-control-lg" name="email" readonly placeholder="email" value="{{$guest->email}}">
                                                    </div>
                                ...
                                <table class="table table-sm table-condensed mb-0">
                                    ...
                                    @foreach($reservations as $key=>$reservation)
                                        <tr>
                                            ...
                                            <td><a class="" href="{{route('reservation.view',$reservation->id)}}">{{$reservation->uid}}</a></td>
