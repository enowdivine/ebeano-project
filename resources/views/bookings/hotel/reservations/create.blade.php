    ...
    <div class="card shadow-sm my-4 px-3 rounded justify-content-center border-0">
        <div class="card-header bg-white">
            <h2>Create Reservation
                <a class="btn btn-tsk float-right" href="{{route('reservations')}}"><i class="fa fa-list"></i> Reservation List</a>
                    ...
                    <div class=" mb-3">
                        <div class="form-row justify-content-center " v-show="next === 1">
                            <div class="form-group col-md-4">
                                <label><strong>Guest</strong> <small class="text-danger">*</small></label><a href="" target="_blank" class="float-right"><i class="fa fa-plus"></i> add new</a>
                                            ...
                                            <td class="price-per-night p-0">
                                                <table class="table table-sm borderless mb-0 ">
                                                    ...
                                                    <tr v-for="(night_date,index ) in form.night_list">
                                                        ...
                                                        <td class="text-right">@{{ night_date.price }} &#8358;</td>
                                                        <td class="text-right">@{{ night_date.total_price }} &#8358;</td>
                                                    </tr>
                                                    <tr class="font-weight-bold">
                                                        <td colspan="5">Total</td>
                                                        <td class="text-right "><span class="border-top">@{{ form.total_night_price }} &#8358;</span></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                            ...
                                            <td class="p-0">
                                                <table class="table table-sm borderless mb-0">
                                                    ...
                                                    <tr>
                                                        <td class="text-muted">
                                                <span>
                                                    Your Applied coupon code :<strong>@{{ form.coupon.code }}</strong> .Discount details @{{ form.coupon.value }} <span v-if="form.coupon.type === 'PERCENTAGE'">% for total night price ( @{{ form.total_night_price }} &#8358;)</span> <span  v-if="form.coupon.type === 'FIXED'">&#8358;</span>
                                                </span>
                                                        </td>
                                                        <td></td>
        ...
        var app = new Vue({
            ...
            watch:{
              ...
              'form.room_type':function (val) {
                  ...
                  this.form.check_out = '';
                  this.disableDates =[];
                    axios.get('{{route('reservation.get_room_type_details')}}',{
                        params:{
                            room_type:val
                        }
                    }).then(res=>{
            ...
            methods:{
                    ...
                    return {
                        ...
                        change:function (el) {
                            ...
                            if( $this.form.room_type === ''){
                                ...
                                axios.get('{{route('reservation.get_checkout_available_date')}}',{
                                    params: {
                ...
                setCheckOutConfig:function(max_date){
                    ...
                    return {
                        ...
                        change:function (el) {
                            ...
                            if(check_out !== ''){
                                axios.get('{{route('reservation.get_night_calculation')}}',{
                                    params: {
                ...
                createData:function (e) {
                    axios.post('{{route('reservation.store')}}',this.form).then(res => {
                        if(res.data.status === 'ok'){
                            this.resetForm();
                ...
                applyCouponCode:function(){
                    ...
                    axios.get('{{route('reservation.apply_coupon')}}',{
                        params:{
