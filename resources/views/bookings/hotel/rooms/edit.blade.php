...
<div class="row">
    ...
    <div class="card shadow-sm my-4 px-3 rounded justify-content-center border-0">
            ...
            <h2>Edit Room
                <a class="btn btn-tsk float-right" href="{{route('room')}}"><i class="fa fa-list"></i> Room List</a>

            </h2>
        </div>
        <div class="card-body">
            <form action="{{route('room.update',$room->id)}}" method="post" enctype="multipart/form-data">@csrf
