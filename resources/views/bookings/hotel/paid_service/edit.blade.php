...
<div class="row">
    ...
    <div class="card shadow-sm my-4 px-3 rounded justify-content-center border-0">
            ...
            <h2>Edit Paid Service
                <a class="btn btn-tsk float-right" href="{{route('paid_service')}}"><i class="fa fa-list"></i> Paid Service List</a>

            </h2>
        </div>
        <div class="card-body">
            <form action="{{route('paid_service.update',$paidService->id)}}" method="post" enctype="multipart/form-data">@csrf
