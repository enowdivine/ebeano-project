            ...
            <div class="card-header bg-white">
                <h2>Room Type
                    <div class=" float-right">
                        ...
                        <a class="btn btn-tsk" href="{{route('room_type.create')}}"><i class="fa fa-plus"></i> Add Room Type</a>
                    </div>
            ...
            <div class="card-body p-0">
                <table class="table table-sm table-condensed mb-0">
                    ...
                    @foreach($roomTypes as $key=>$roomType)
                        @include('bookings.hotel.roomtype.regular_price',['data'=>$roomType])
                    <tr>
                        <td>{{$key+1}}</td>
                                ...
                                <div class="btn-group  btn-group-sm" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                        ...
                                        <a class="dropdown-item spaicel-btn"
                                           data-url="{{route('special_price_update',$roomType->id)}}"
                                           data-toggle="modal" data-target="#special_price" href="#">Special Price</a>
                                    </div>
                                </div>

                                <a href="{{route('room_type.view',$roomType->id)}}" class="btn btn-outline-tsk"><i class="fa fa-eye"></i> </a>
                                <a href="{{route('room_type.edit',$roomType->id)}}" class="btn btn-outline-tsk"><i class="la la-pencil"></i> </a>
                            </div>
                        </td>
                    </tr>
                        @endforeach
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form class="" action="{{route('room_type_upload_image')}}" method="post" enctype="multipart/form-data">@csrf
