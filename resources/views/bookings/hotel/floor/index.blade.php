...
<div class="row">
    ...
    <div class="card shadow-sm my-4 px-3 rounded justify-content-center border-0">
            <div class="card-header bg-white">
                <h2>Floor
                    <a class="btn btn-tsk float-right" href="{{route('floor.create')}}"><i class="fa fa-plus"></i>Add Floor</a>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="btn-group btn-group-sm">
                                <a href="{{route('floor.edit',$floor->id)}}" class="btn btn-tsk"><i class="la la-pencil"></i> Edit</a>
                           </div>
                        </td>
                    </tr>
                        @endforeach
