                                ...
                                <table id="datable_g_1" class="table table-hover display  pb-30" >
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                        ...
                                        <td>{{$i}}</td>
                                       <td>{{$job->user->name}}</td>
                                       <td>{{$job->artisan->name}}</td>
                                       <td>{{$job->status}}</td>
                                       <td><a href="{{url('eb-admin/jobs/'.encrypt($job->id))}}" class="mr-25" data-toggle="tooltip" data-original-title="View"> <i class="fa fa-page text-inverse m-r-10"></i> </a> 
                                       </td>
