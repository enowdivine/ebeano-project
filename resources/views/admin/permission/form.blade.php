    ...
    <div class="row heading-bg">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{url('eb-admin/staff')}}">Staff</a></li>
    ...
    @endif 
            ...
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">{{isset($edit)?('Edit Permission'):('Add Permission')}}</h6>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        ...
                        <div class="form-wrap">
                        <form class="" action="{{isset($edit)?url('eb-admin/staff/permissions/update/'.$edit->id):('post-permission')}}" method="POST" >
                            ...
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="code" class="form-control" value="{{!empty($edit->code)?$edit->code:('')}}" id="code">
                                </div>
